...
function draw() {
	...
	function robot_data_send() {
		...
		if (a0_1000 != a0_1000_last_frame || a1_1000 != a1_1000_last_frame || a2_1000 != a2_1000_last_frame) {
			...
			xmlhttp.open("GET", "bosch2.html/query?a0_1000=" + a1_out_1000 + "&a1_1000=" + a2_out_1000 + "&a2_1000=" + a3_out_1000, true);
			xmlhttp.send();
		};
	...
	function robot_data_send_robot_server() {
		...
		if (a0_1000 != a0_1000_last_frame || a1_1000 != a1_1000_last_frame || a2_1000 != a2_1000_last_frame) {
			...
			xmlhttp2.open("GET", "http://192.168.153.130:40000/bosch2.html/query?a0_1000=" + a1_out_1000 + "&a1_1000=" + a2_out_1000 + "&a2_1000=" + a3_out_1000, true);
