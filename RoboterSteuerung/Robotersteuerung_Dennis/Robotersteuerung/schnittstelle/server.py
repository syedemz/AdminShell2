...
import json
from Verwaltungsschale.AdministrationShell_complete.structure import module
from Verwaltungsschale.AdministrationShell_complete.structure import configuration
...
#                MESSAGE = self.server_con.create_message(CORE_pyobj = antwort, MESSAGE_received = MESSAGE )
#                self.server_con.send(MESSAGE)
                print(antwort)
